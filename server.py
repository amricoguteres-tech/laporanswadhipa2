...
class AppHandler(BaseHTTPRequestHandler):
    ...
    def send_json(self, status, payload):
        ...
        self.send_header("Content-Security-Policy", "default-src 'self' https://cdn.phototourl.com; img-src 'self' https://cdn.phototourl.com data:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; script-src 'self' 'unsafe-inline'; object-src 'none'; base-uri 'self'; frame-ancestors 'none'")
        self.end_headers()
